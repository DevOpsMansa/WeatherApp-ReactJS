...
const WeatherCard = ({
  ...
  const [icon, setIcon] = useState(sun); // State to manage weather icon
  const { time } = useDate(); // Accessing current time using custom hook
  ...
  // Rendering weather card with weather information
  return (
